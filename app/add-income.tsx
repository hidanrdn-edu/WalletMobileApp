...
export default function AddIncomeScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const fetchedCategories = await listCategoriesByUserAndType(currentUser.id, 'income');
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setErrorMessage(error instanceof Error ? error.message : 'Не вдалося зберегти дохід.');
    }
  };
